...
evidence-freeze:
	python scripts/build_current_evidence_freeze.py

freeze-aligned-text:
	python scripts/build_freeze_aligned_manuscript_text.py

external-review-docx:
	python scripts/build_external_review_docx.py

figure-caption-audit:
	python scripts/build_figure_caption_source_audit.py

author-declaration-packet:
	python scripts/build_author_declaration_confirmation_packet.py

author-declaration-email:
