...
Generated by `python scripts/build_project_gantt.py` on 2026-05-10.

Dates after 2026-05-10 are planned dates, not completed evidence.
...
```mermaid
gantt
    title RMTGuard project progress as of 2026-05-10
