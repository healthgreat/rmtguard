...
gantt
    ...
    Matched Seurat/JackStraw baseline design :done, T24, 2026-05-03, 1d
    Local matched Python baseline pilot :done, T25, 2026-05-03, 1d
    Official Seurat MTX bridge and smoke :done, T26, 2026-05-03, 1d
    Official Seurat fixed-PC/elbow 20-repeat comparator :done, T27, 2026-05-03, 1d
    Official Seurat JackStraw 20-repeat comparator :done, T28, 2026-05-03, 1d
    Paired RMTGuard vs official Seurat statistics :done, T29, 2026-05-03, 1d
    Added-dataset official Seurat rows :done, T30, 2026-05-03, 1d
    Direct scLENSpy n_rand_matrix=20 comparator :done, T31, 2026-05-12, 1d
    CONCORD-style topology stress benchmark :done, T32, 2026-05-12, 1d
    Paul15 real-data topology monitor :T33, 2026-05-12, 1d
    Additional public datasets :done, T37, 2026-05-03, 1d
    ...
    Final figure source data; captions; and reporting summary :T38, 2026-06-02, 15d
    ...
    Nature Methods presubmission go/no-go packet :T41, 2026-05-10, 1d
    Nature Methods vs Genome Biology go/no-go :T42, 2026-06-21, 15d
    Submission package freeze :T43, 2026-07-06, 14d
    ...
    PDAC/TME deep validation first pass :T34, 2026-05-10, 1d
    PDAC/TME pathway and atlas upgrade :T35, 2026-05-10, 1d
    PDAC/TME final Figure 4 wording freeze :T36, 2026-05-10, 1d
    section Release
    Public GitHub repository; release; and Zenodo DOI :done, T14, 2026-05-02, 3d
    Post-release gates and reproducibility audit :done, T39, 2026-05-04, 1d
    Cross-project shared information package :done, T40, 2026-05-04, 1d
    section Statistics
...
| T24 | Public benchmark | Matched Seurat/JackStraw baseline design | 2026-05-03 | 2026-05-03 | done | 100% | `docs/matched_baseline_design.md` |
| T25 | Public benchmark | Local matched Python baseline pilot | 2026-05-03 | 2026-05-03 | done | 100% | `docs/matched_baseline_pilot.md` |
| T26 | Public benchmark | Official Seurat MTX bridge and smoke | 2026-05-03 | 2026-05-03 | done | 100% | `docs/seurat_matched_baseline.md` |
| T27 | Public benchmark | Official Seurat fixed-PC/elbow 20-repeat comparator | 2026-05-03 | 2026-05-03 | done | 100% | `docs/seurat_matched_baseline.md` |
| T28 | Public benchmark | Official Seurat JackStraw 20-repeat comparator | 2026-05-03 | 2026-05-03 | done | 100% | `docs/seurat_jackstraw_feasibility.md` |
| T29 | Public benchmark | Paired RMTGuard vs official Seurat statistics | 2026-05-03 | 2026-05-03 | done | 100% | `docs/rmtguard_seurat_paired_statistics.md` |
| T30 | Public benchmark | Added-dataset official Seurat rows | 2026-05-03 | 2026-05-03 | done | 100% | `docs/seurat_matched_baseline.md` |
| T31 | Public benchmark | Direct scLENSpy n_rand_matrix=20 comparator | 2026-05-12 | 2026-05-12 | done | 100% | `docs/sclens_stability_nrand20_2026-05-12.md` |
| T32 | Public benchmark | CONCORD-style topology stress benchmark | 2026-05-12 | 2026-05-12 | done | 100% | `docs/topology_stress_benchmark_2026-05-12.md` |
| T33 | Public benchmark | Paul15 real-data topology monitor | 2026-05-12 | 2026-05-12 | done_with_limit | 90% | `docs/realdata_topology_benchmark_2026-05-12.md` |
| T34 | Biological application | PDAC/TME deep validation first pass | 2026-05-10 | 2026-05-10 | done_with_limit | 75% | `docs/pdac_tme_deep_validation.md` |
| T35 | Biological application | PDAC/TME pathway and atlas upgrade | 2026-05-10 | 2026-05-10 | done_with_limit | 85% | `docs/pdac_tme_pathway_atlas_validation.md` |
| T36 | Biological application | PDAC/TME final Figure 4 wording freeze | 2026-05-10 | 2026-05-10 | done_with_limit | 90% | `docs/figure4_pdac_tme_wording_freeze.md` |
| T37 | Public benchmark | Additional public datasets | 2026-05-03 | 2026-05-03 | done | 100% | `docs/manuscript_grade_stability_statistics.md` |
| T38 | Manuscript package | Final figure source data, captions, and reporting summary | 2026-06-02 | 2026-06-16 | planned | 0% | `docs/nature_reporting_summary_draft.md` |
| T39 | Release | Post-release gates and reproducibility audit | 2026-05-04 | 2026-05-04 | done | 100% | `results/submission/submission_guard.tsv` |
| T40 | Release | Cross-project shared information package | 2026-05-04 | 2026-05-04 | done | 100% | `docs/shared_info_export_manifest.md` |
| T41 | Journal route | Nature Methods presubmission go/no-go packet | 2026-05-10 | 2026-05-10 | done_with_limit | 90% | `docs/nature_methods_go_no_go_final.md` |
| T42 | Journal route | Nature Methods vs Genome Biology go/no-go | 2026-06-21 | 2026-07-05 | planned | 0% | `results/submission/post_feedback_journal_route_gate.tsv` |
| T43 | Journal route | Submission package freeze | 2026-07-06 | 2026-07-19 | planned | 0% | `results/submission/presubmission_gatekeeper.tsv` |
