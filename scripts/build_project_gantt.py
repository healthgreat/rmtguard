...
TASKS = [
    ...
    Task(
        ...
        "Blocked until author creates real public GitHub/Zenodo release assets.",
    ),
    Task(
        "Statistics",
    ...
    Task(
        ...
        "Cannot pass until public GitHub/Zenodo evidence exists.",
    ),
    Task(
        "Journal route",
...
def build_markdown(df: pd.DataFrame) -> str:
    ...
    lines.extend(
        [
            ...
            "## Current blockers",
            "",
            "- Public GitHub repository, GitHub Release, and Zenodo DOI remain external blockers.",
