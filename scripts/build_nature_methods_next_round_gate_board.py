...
GATES = [
    ...
    Gate(
        ...
        "Codex",
        "biological_showcase",
        "results/pdac_tme/pathway_atlas_validation",
        "Use completed DE, signature transfer, rank-based MSigDB Hallmark/Reactome enrichment, and atlas marker citation mapping as bounded Figure 4 support; obtain final author route confirmation.",
        "results/pdac_tme/pathway_atlas_validation/pdac_pathway_atlas_validation_summary.tsv",
        "PDAC/TME can remain a bounded main-figure candidate if final wording uses only supported pathway/atlas evidence and avoids disease-mechanism claims.",
        "Demote PDAC/TME if author route confirmation is not provided or if final figure wording drifts into unsupported mechanism/clinical claims.",
