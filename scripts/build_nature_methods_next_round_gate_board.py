...
GATES = [
    ...
    Gate(
        ...
        "biological_showcase",
        "results/pdac_tme",
        "If PDAC/TME is kept as a main figure, add differential expression, GSEA/pathway, published-atlas marker validation, and GSE263733 external validation.",
        "results/pdac_tme/pdac_tme_deep_validation_summary.tsv",
        "At least one stable, interpretable PDAC/TME state has marker/pathway support and external validation without overclaiming clinical mechanism.",
        "Demote PDAC/TME if validation is marker-only or if external validation remains weak.",
