...
GATES = [
    ...
    Gate(
        "NM-G02",
        "P0",
        "synthetic_20_repeat_done_realdata_pending",
        "Codex",
        "draft_repeat_count;component_ablation",
        "docs/p0_science_sprint_status.md",
        "Scale the labeled real-data ablation annotation checks to 20 repeats and keep the synthetic 20-repeat CI layer as supporting evidence.",
...
def build_markdown(rows: list[dict[str, str]]) -> str:
    ...
    lines = [
        ...
        "",
        "1. Scale the labeled real-data ablation checks from the current 10-repeat pilot to 20 repeats.",
