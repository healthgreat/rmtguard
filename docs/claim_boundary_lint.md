...
- Violations: `0`
- Controlled boundary mentions: `136`
...
- `premature_doi_release` in `manuscript/submission_readiness.md:13`
- ... 36 additional controlled mentions omitted from Markdown summary.
