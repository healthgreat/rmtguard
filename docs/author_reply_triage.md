...
| v0_1_1_preflight | `still_do_not_release` | blocking_or_holding_gates=author_declarations;corresponding_author_figure4_ack;figure_caption_source_audit | release_remains_blocked | After exact author confirmations are recorded, rerun author packet, preflight, dashboard, evidence freeze, and shared export. |
